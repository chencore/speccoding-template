...
- **dashboard** — 产品工作台仪表盘：聚合统计、pending 选题 mock 指标、进行中文案 `[v0.2 新增 · home-dashboard]`
...
### 决策 4：全局左侧导航布局 `[v0.2 新增 · home-dashboard]`
- **选择**：所有页面统一包裹 `SidebarLayout`，左侧固定 220px 导航栏
- **放弃的方案**：每个页面独立导航或仅首页有导航
- **理由**：v0.2 产品工作台需要统一入口感；脚本/视频/音频/数据分析等未来模块可在侧边栏占位
